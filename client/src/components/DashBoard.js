  ...
  const handleChange = (e) => {
    ...
    switch (e.target.name) {
      ...
      case "equipmentType":
        ...
        //   ...prevState,
        //   equipmentType: selectedValues
        // }));

        // console.log("VALUE", e.target.addressInfo.equipmentType[0]);
        ...
        //   console.log(e.target.selectedOptions[i]);
        // }

        //  for (let i = 0; i < e.target.addressInfo.equipmentType.options.length; i++) {
        //     if (e.target.addressInfo.equipmentType.options[i].selected) {
        //       console.log(e.target.addressInfo.equipmentType.options[i].value);
        //     }
        //   }
        break;
      case "email":
